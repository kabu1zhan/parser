...
login_button = Button(login_frame, command=send_login, text="Войти")
...
level = Scale(page2, from_=1, to=3, orient=HORIZONTAL)
level.grid(row=5, column=0, stick='nswe')
page3 = Frame(app)
